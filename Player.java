    ...
    public ActionMessage act() {
        ...
        if (diceRoll + rehearsalChips >= scene.getBudget()) {
            ...
            if(currentRole.isOnCard()) {
                ...
                return message = new ActionMessage(name + " succeeded in acting and has earned 2 credits!", bonusMessage);
            } else {
                addCredits(1);
                addMoney(1);
                set.removeShot();
                ...
                return message = new ActionMessage(name + " succeeded in acting and has earned 1 credit and 1 dollar!", bonusMessage);
            }
        }
